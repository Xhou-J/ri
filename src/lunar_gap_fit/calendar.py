...
SUPPORTED_FIT_START = date(1901, 1, 1)
SUPPORTED_FIT_END = date(2100, 12, 31)
CALENDAR_SOURCE_NAME = "Hong Kong Observatory Gregorian-Lunar Calendar Conversion Table, 1901-2100"
CALENDAR_SOURCE_URL = "https://www.hko.gov.hk/en/gts/time/conversion.htm"
CALENDAR_DATA_NOTE = (
    "The encoded 1901-2100 lunar calendar table is kept aligned with the "
    "Hong Kong Observatory Gregorian-Lunar conversion table used by this project."
)
LUNAR_INFO_ENCODING = "comma-separated decimal integers for lunar years 1900-2100"
LUNAR_INFO_SHA256 = "c50527baa2f4b4d476902b4fea1d062660c33a5727c184a14d01904d4ee0a0ca"
